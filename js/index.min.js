...
function setStationName(t) {
    document.title = "▶ " + t, $("title").attr("title", t), $("#rjp-stationname a").text(t)
}
$(document).ready(function() {
    fetchStation(stationPrettyUrl).done(function(t) {
        ...
        setStationName(e.name), setStationLink(e.pretty_url), setStationImages(e), fetchStationCards(e.key).done(function(t) {
            ...
            void 0 !== n && (e.description = n.text), setMetaTags(e)
        });
        ...
        getPartnerIds().then(t => {
            ...
            a.src = e.streamUrl + n, a.load(), setInterval(function() {
...
var setStationLink = function(t) {
    $(".dashboard-box__playing-img a").attr("href", siteUrl + "/" + t), $("#rjp-stationname a").attr("href", siteUrl + "/" + t)
};
...
function setStationImages(t) {
    ...
    var e = $(".dashboard-box__playing-img a"),
        a = new Image;
    a.src = getStationImageUrl(t), a.alt = t.name, a.onload = function() {
        var t = a.width / a.height;
        $(a).data("aspect-ratio", t), t >= 1 ? e.addClass("landscape") : e.addClass("portrait"), $(a).appendTo(e)
    }
}

function setMetaTags(t, e) {
    $('meta[property="og:title"]').attr("content", t.name), $('meta[name="twitter:title"]').attr("content", t.name), $('meta[name="twitter:image:alt"]').attr("content", t.name), $('meta[property="og:url"]').attr("content", siteUrl + "/" + t.pretty_url), $('meta[property="og:description"]').attr("content", sanitizeHTML(t.description)), $('meta[name="twitter:description"]').attr("content", sanitizeHTML(t.description)), $('meta[property="og:image"]').attr("content", getStationImageUrl(t, "200x200")), $('meta[name="twitter:image"]').attr("content", getStationImageUrl(t, "125x125")), $('meta[property="og:audio"]').attr("content", t.streamUrl), $('meta[name="twitter:player:stream"]').attr("content", t.streamUrl), $('meta[name="twitter:player"]').attr("content", siteUrl + "/player.php?stream=" + t.streamUrl)
}
...
function getStationImageUrl(t, e) {
    return e || (e = "350x350"), "https://stream-tools.zenomedia.com/content/stations/" + t.key + "/image/?keep=w&lu=" + t.updated + "&resize=" + e
}
...
function setAppLinks(t) {
    t && void 0 !== t.appstore && $("#appstore").attr("href", t.appstore).show(), t && void 0 !== t.playstore && $("#playstore").attr("href", t.playstore).show()
}
...
function setNowPlaying(t) {
    getNowPlayingData(t).then(function(t) {
        t.title && $(".dashboard-box__playing-song").text(t.title), t.artist && $(".dashboard-box__playing-artist").text(t.artist)
    })
}
