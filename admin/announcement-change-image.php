...
$query=mysqli_query($con,"update tblannouncement set PostImage='$imgnewfile' where id='$postid'");
if($query)
{
...
<?php
$postid=intval($_GET['pid']);
$query=mysqli_query($con,"select PostImage,PostTitle from tblannouncement where id='$postid' and Is_Active=1 ");
