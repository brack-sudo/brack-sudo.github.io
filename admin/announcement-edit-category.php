...
$query=mysqli_query($con,"Update  tblannouncementcatagory set CategoryName='$category',Description='$description' where id='$catid'");
if($query)
{
...
<?php 
$catid=intval($_GET['cid']);
$query=mysqli_query($con,"Select id,CategoryName,Description,PostingDate,UpdationDate from  tblannouncementcatagory where Is_Active=1 and id='$catid'");
$cnt=1;
