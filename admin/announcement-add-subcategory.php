...
$status=1;
$query=mysqli_query($con,"insert into tblannouncementsubcatagory(CategoryId,Subcategory,SubCatDescription,Is_Active) values('$categoryid','$subcatname','$subcatdescription','$status')");
if($query)
{
