...
$status=1;
$query=mysqli_query($con,"insert into tblannouncementcatagory(CategoryName,Description,Is_Active) values('$category','$description','$status')");
if($query)
{
...
<html lang="en">
    <head>
        ...
        <title>DU Radio | Add Category</title>
