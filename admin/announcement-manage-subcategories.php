...
{
	$id=intval($_GET['scid']);
	$query=mysqli_query($con,"update  tblannouncementsubcatagory set Is_Active='0' where SubCategoryId='$id'");
...
if($_GET['resid'])
{
	...
	$query=mysqli_query($con,"update  tblannouncementsubcatagory set Is_Active='1' where SubCategoryId='$id'");
...
{
	$id=intval($_GET['scid']);
	$query=mysqli_query($con,"delete from   tblannouncementsubcatagory  where SubCategoryId='$id'");
...
<div class="m-b-30">
<a href="announcement-add-subcategory.php">
<button id="addToTable" class="btn btn-success waves-effect waves-light">Add <i class="mdi mdi-plus-circle-outline" ></i></button>
												...
												<div class="table-responsive">
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select tblannouncementcatagory.CategoryName as catname,tblannouncementsubcatagory.Subcategory as subcatname,tblannouncementsubcatagory.SubCatDescription as SubCatDescription,tblannouncementsubcatagory.PostingDate as subcatpostingdate,tblannouncementsubcatagory.UpdationDate as subcatupdationdate,tblannouncementsubcatagory.SubCategoryId as subcatid from tblannouncementsubcatagory join tblannouncementcatagory on tblannouncementsubcatagory.CategoryId=tblannouncementcatagory.id where tblannouncementsubcatagory.Is_Active=1");
$cnt=1;
...
<div class="table-responsive">
   <table class="table m-0 table-colored-bordered table-bordered-danger">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select tblannouncementcatagory.CategoryName as catname,tblannouncementsubcatagory.Subcategory as subcatname,tblannouncementsubcatagory.SubCatDescription as SubCatDescription,tblannouncementsubcatagory.PostingDate as subcatpostingdate,tblannouncementsubcatagory.UpdationDate as subcatupdationdate,tblannouncementsubcatagory.SubCategoryId as subcatid from tblannouncementsubcatagory join tblannouncementcatagory on tblannouncementsubcatagory.CategoryId=tblannouncementcatagory.id where tblannouncementsubcatagory.Is_Active=0");
$cnt=1;
$rowcount=mysqli_num_rows($query);
if($rowcount==0)
{
