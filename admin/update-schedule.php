...
$query=mysqli_query($con,"update tblschedule set PageTitle='$pagetitle',Description='$pagedetails' where PageName='$pagetype' ");
if($query)
{
...
<?php 
$pagetype='schedule';
$query=mysqli_query($con,"select PageTitle,Description from tblschedule where PageName='$pagetype'");
